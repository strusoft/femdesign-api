...
class CmdUser(Command):
    def __init__(self, module : User):
        self.module = f"; CXL $MODULE {module.name}"

    def to_xml_element(self) -> ET.Element:
        cmd_user = ET.Element("cmduser")
        cmd_user.attrib = self.module
        
        return cmd_user
    
class CmdOpen(Command):
    attributes = {
        "command": "; CXL CS2SHELL OPEN"
    }
    ...
    def to_xml_element(self) -> ET.Element:
        ...
        cmd_open.attrib = CmdOpen.attributes

        return cmd_open

class CmdSave(Command):
    attributes = {
        "command": "; CXL CS2SHELL SAVE"
    }
    ...
    def to_xml_element(self) -> ET.Element:
        ...
        cmd_save.attrib = CmdSave.attributes
...
class CmdCalculation(Command):
    ...
    def to_xml_element(self) -> ET.Element:
        ...
        cmd_calculation.attrib = CmdCalculation.attributes
...
class FdscriptHeader:
    ...
    def to_xml_element(self) -> ET.Element:
        fdscript_header = ET.Element(self.root)
