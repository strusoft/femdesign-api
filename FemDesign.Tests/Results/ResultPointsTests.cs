...
namespace FemDesign.Results
{
    ...
    public class ResultPointsTests
    {
        ...
        public void ResPoints()
        {
            ...
            var results = connection.GetLoadCaseResults<Results.ShellDisplacement>(loadCase: null, elements: null, options: new Options(BarResultPosition.ResultPoints, ShellResultPosition.ResultPoints) );
