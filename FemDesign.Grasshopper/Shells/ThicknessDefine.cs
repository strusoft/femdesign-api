...
namespace FemDesign.Grasshopper
{
    ...
    {
        public Thickness_Define(): base("Thickness.Define", "Define", "Create a Thickness object. Thickness objects are used to define Plates and Walls with variable thickness, [t1, t2, t3] and [t1, t2] respectively.", CategoryName.Name(), SubCategoryName.Cat3())
        {
