...
namespace FemDesign.Grasshopper
{
    ...
    {
        public SlabAverageMeshSize(): base("Slab.AverageSurfaceElementSize", "AvgSrfElemSize", "Set average surface element size to slab.", CategoryName.Name(), SubCategoryName.Cat3())
        {
