...
namespace FemDesign.Grasshopper
{
    public class SlabPlateVariableThickness: FEM_Design_API_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // create a slab plate
            FemDesign.Shells.Slab obj = FemDesign.Shells.Slab.Plate(identifier, material, region, FemDesign.Shells.EdgeConnection.Rigid, eccentricity, orthotropy, thickness);
        ...
        {
            get { return new Guid("{B53609A9-9A1E-45CD-ACB9-6252326DFA12}"); }
        }
