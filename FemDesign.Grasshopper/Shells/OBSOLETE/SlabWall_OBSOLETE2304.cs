...
{
    public class SlabWall_OBSOLETE2304 : FEM_Design_API_Component
    {
        public SlabWall_OBSOLETE2304(): base("Wall", "Construct", "Construct a wall element.", CategoryName.Name(), SubCategoryName.Cat2b())
        {
