...
{
    public class EdgeConnectionConstruct_OBSOLETE: FEM_Design_API_Component
    {
        public EdgeConnectionConstruct_OBSOLETE(): base("EdgeConnection.Construct", "Construct", "Construct a new EdgeConnection", CategoryName.Name(), SubCategoryName.Cat2b())
        {
