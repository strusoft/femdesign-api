...
namespace FemDesign.GH
{
    ...
    {
        public LoadCaseGetLoadCaseByName(): base("LoadCase.GetLoadCaseFromListByName", "GetLoadCaseByName", "Returns a LoadCase from a list of LoadCases by name. The first LoadCase with a matching name will be returned.", "FemDesign", "Loads")
        {
