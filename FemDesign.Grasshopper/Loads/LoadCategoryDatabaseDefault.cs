...
namespace FemDesign.Grasshopper
{
    ...
    {
        public LoadCategoryDefault(): base("LoadCategoryDatabase.Default", "Default", "Load the default LoadCategoryDatabase for each respective country.", CategoryName.Name(), SubCategoryName.Cat6())
        {
