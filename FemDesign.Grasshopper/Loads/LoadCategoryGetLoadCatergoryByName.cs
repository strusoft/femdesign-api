...
namespace FemDesign.Grasshopper
{
   public class GetLoadCategoryByName: GH_Component
    {
        public GetLoadCategoryByName(): base("LoadCategory.GetLoadCategoryByName", "GetLoadCategoryByName", "Get LoadCategory from LoadCategoryDatabase by name.", CategoryName.Name(), SubCategoryName.Cat6())
        {
