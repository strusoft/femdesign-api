...
namespace FemDesign.Grasshopper
{
    ...
    {
        public SurfaceLoadVariable(): base("SurfaceLoad.Variable", "Variable", "Create a variable surface load.", "FemDesign", "Loads")
        {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            //
            FemDesign.Loads.SurfaceLoad obj = FemDesign.Loads.SurfaceLoad.Variable(region, fdVector, loads, loadCase, comment);
