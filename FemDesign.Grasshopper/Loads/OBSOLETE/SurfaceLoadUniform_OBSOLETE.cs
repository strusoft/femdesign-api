...
{
    public class SurfaceLoadUniform_OBSOLETE: FEM_Design_API_Component
    {
        public SurfaceLoadUniform_OBSOLETE(): base("SurfaceLoad.Uniform", "Uniform", "Create a uniform surface load.", CategoryName.Name(), SubCategoryName.Cat3())
        {
