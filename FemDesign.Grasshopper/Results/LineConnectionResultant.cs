    ...
    public class LineConnectionResultant : GH_Component
    {
        ...
        public LineConnectionResultant()
          : base("LineConnectionResultant",
                ...
                "Read the Line Connection Resultant Force for the elements",
        ...
        {
            // get indata
            List<FemDesign.Results.LineConnectionResultant> iResult = new List<FemDesign.Results.LineConnectionResultant>();
            ...
            DataTree<object> halfLengthResultTree = new DataTree<object>();
            ...
            foreach (var id in uniqueId)
            {
                ...
                foreach (int index in indexes)
                {
                    ...
                    halfLengthResultTree.Add(iResult.ElementAt(index).HalfLength, new GH_Path(ghPath, i));
            ...
            DA.SetDataTree(2, halfLengthResultTree);
        ...
        {
            get { return new Guid("{3ED42C3B-DA2F-4A48-AC1F-C05436E65B29}"); }
        }
    }
}