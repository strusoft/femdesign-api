...
namespace FemDesign.Grasshopper
{
    ...
    {
        public ModelCreate3OBSOLETE() : base("Model.Create", "Create", "Create new model. Add entities to model. Nested lists are not supported.", CategoryName.Name(), SubCategoryName.Cat7())
        {
