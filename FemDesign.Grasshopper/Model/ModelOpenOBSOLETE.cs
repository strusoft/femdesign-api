...
{
    public class ModelOpenOBSOLETE: GH_Component
    {
        public ModelOpenOBSOLETE(): base("Model.Open", "Open", "Open model in FEM-Design.", CategoryName.Name(), SubCategoryName.Cat6())
        {
