...
namespace FemDesign.Grasshopper
{
    ...
    {
        public MotionsRigidLine(): base("Motions.RigidLine", "RigidLine", "Define a rigid motions release for a line-type release (1.000e+7).", CategoryName.Name(), SubCategoryName.Cat6a())
        {
