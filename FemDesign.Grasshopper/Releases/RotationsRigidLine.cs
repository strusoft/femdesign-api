...
namespace FemDesign.Grasshopper
{
    ...
    {
        public RotationsRigidLine(): base("Rotations.RigidLine", "RigidLine", "Define a rigid rotations release for a line-type release (1e+07 kNm/m/rad).", CategoryName.Name(), SubCategoryName.Cat6a())
        {
