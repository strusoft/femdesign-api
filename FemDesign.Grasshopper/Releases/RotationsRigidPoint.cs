...
namespace FemDesign.Grasshopper
{
    ...
    {
        public RotationsRigidPoint(): base("Rotations.RigidPoint", "RigidPoint", "Define a rigid rotations release for a point-type release (1e+10 kNm/rad).", "FEM-Design", "Releases")
        {
