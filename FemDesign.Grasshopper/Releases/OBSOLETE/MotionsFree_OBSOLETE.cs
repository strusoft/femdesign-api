...
{
    public class MotionsFree_OBSOLETE: FEM_Design_API_Component
    {
        public MotionsFree_OBSOLETE(): base("Motions.Free", "Free", "Define a free motions release.", CategoryName.Name(), SubCategoryName.Cat5())
        {
