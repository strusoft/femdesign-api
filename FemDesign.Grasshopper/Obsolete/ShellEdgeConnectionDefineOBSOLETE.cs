...
namespace FemDesign.Grasshopper
{
    ...
    {
        public ShellEdgeConnectionDefineOBSOLETE() : base("ShellEdgeConnection.Define", "Define", "Define a new ShellEdgeConnection", CategoryName.Name(), SubCategoryName.Cat3())
        {
