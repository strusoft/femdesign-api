...
namespace FemDesign.Grasshopper
{
    ...
    {
        CompositeSectionBeamB() : base("CompositeSection.BeamB", "CompositeSection", "Composite section. For more information check FEM-Design GUI.", CategoryName.Name(), SubCategoryName.Cat2a())
        {
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                return FemDesign.Properties.Resources.CompositeBeamB;
            }
        }
        public override Guid ComponentGuid
        {
            get { return new Guid("{0D2491DF-757F-46A2-B1EC-60245B97FCC9}"); }
        }
