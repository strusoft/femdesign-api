...
{
    public class BarsColumn_OBSOLETE_2160 : FEM_Design_API_Component
    {
        public BarsColumn_OBSOLETE_2160() : base("Bars.Column", "Column", "Create a bar element of type column.", CategoryName.Name(),
