...
{
    public class TrussBehaviour_OBSOLETE2305 : FEM_Design_API_Component
    {
        public TrussBehaviour_OBSOLETE2305() : base("TrussBehaviour", "TrussBehaviour", "Define a truss behaviour object.", CategoryName.Name(),
