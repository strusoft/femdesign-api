...
namespace FemDesign.Grasshopper
{
    ...
    {
        public MaterialTimberPlateMaterial() : base("TimberPlateMaterial", "Define", "Define timber factor parameters for a timber panel type.", CategoryName.Name(), SubCategoryName.Cat5())
        {
