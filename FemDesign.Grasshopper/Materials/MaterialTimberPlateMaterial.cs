...
namespace FemDesign.Grasshopper
{
    ...
    {
        public MaterialTimberPlateMaterial() : base("Material.TimberPlateMaterial", "Define", "Define timber factor parameters for a timber panel type.", "FemDesign", "Materials")
        {
