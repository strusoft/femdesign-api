...
namespace FemDesign.Grasshopper
{
   public class MaterialGetMaterialByNameOBSOLETE: GH_Component
    {
        public MaterialGetMaterialByNameOBSOLETE(): base("Material.GetMaterialByName", "GetMaterialByName", "Get Material from MaterialDatabase by name.", CategoryName.Name(), SubCategoryName.Cat5())
        {
