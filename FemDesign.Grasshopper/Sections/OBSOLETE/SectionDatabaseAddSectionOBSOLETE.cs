...
namespace FemDesign.Grasshopper
{
    ...
    {
       public SectionDatabaseAddSectionOBSOLETE(): base("SectionDatabase.AddSection", "AddSection", "Add a section to the SectionDatabase.", CategoryName.Name(), SubCategoryName.Cat4())
       {
