...
{
    public class SectionDeconstruct_OBSOLETE2307: FEM_Design_API_Component
    {
       public SectionDeconstruct_OBSOLETE2307(): base("Section.Deconstruct", "Deconstruct", "Deconstruct a Section.", "FEM-Design", "Deconstruct")
       {
