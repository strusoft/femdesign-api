...
{
    public class ModelDeconstructOBSOLETE2150 : FEM_Design_API_Component
    {
        public ModelDeconstructOBSOLETE2150() : base("Model.Deconstruct", "Deconstruct", "Deconstruct Model.", "FEM-Design", "Deconstruct")
        {
