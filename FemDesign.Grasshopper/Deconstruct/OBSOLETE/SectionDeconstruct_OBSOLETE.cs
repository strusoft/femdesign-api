...
{
    public class SectionDeconstruct_OBSOLETE : GH_Component
    {
        public SectionDeconstruct_OBSOLETE() : base("Section.Deconstruct", "Deconstruct", "Deconstruct a Section.", "FEM-Design", "Deconstruct")
        {
