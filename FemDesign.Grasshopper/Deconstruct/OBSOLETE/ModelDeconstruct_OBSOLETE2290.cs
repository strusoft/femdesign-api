...
{
    public class ModelDeconstruct_OBSOLETE2290 : FEM_Design_API_Component
    {
        public ModelDeconstruct_OBSOLETE2290() : base("Model.Deconstruct", "Deconstruct", "Deconstruct Model.", "FEM-Design", "Deconstruct")
        {
