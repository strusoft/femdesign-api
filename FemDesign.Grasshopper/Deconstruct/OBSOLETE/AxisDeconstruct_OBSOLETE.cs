...
{
    public class AxisDeconstruct_OBSOLETE: FEM_Design_API_Component
    {
       public AxisDeconstruct_OBSOLETE(): base("Axis.Deconstruct", "Deconstruct", "Deconstruct an axis element.", "FEM-Design", "Deconstruct")
       {
