...
{
    public class PointConnection_OBSOLETE : FEM_Design_API_Component
    {
        public PointConnection_OBSOLETE() : base("PointConnection", "PtConnect", "Construct a Point Connection.", "FEM-Design", "ModellingTools")
        {
