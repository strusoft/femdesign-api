...
namespace FemDesign.Grasshopper
{
    public class SurfaceConnection : FEM_Design_API_Component
    {
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager[pManager.ParamCount - 1].Optional = true;
            pManager.AddNumberParameter("Distance", "d", "Distance in meter.", GH_ParamAccess.item, 0);
            pManager[pManager.ParamCount - 1].Optional = true;
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Releases.MotionsPlasticLimits limits = null;
            ...
            double distance = 0;
            DA.GetData(6, ref distance);
            if (distance < 0)
            {
                AddRuntimeMessage(GH_RuntimeMessageLevel.Error, "Distance must be positive.");
            }
            ...
            var obj = new FemDesign.ModellingTools.SurfaceConnection(fdSuface, rigidity, refs, identifier, distance);
        ...
        {
            get { return new Guid("{5C965AFE-FA8F-4161-B85C-ED51B3154D37}"); }
        }
