...
{
    public class FictitiousShellSetEdgeConnection_OBSOLETE2304 : FEM_Design_API_Component
    {
        public FictitiousShellSetEdgeConnection_OBSOLETE2304(): base("FictitiousShell.SetEdgeConnection", "SetEdgeConnection", "Set EdgeConnection by index. Index for each respective edge can be extracted using FictitiousShellDeconstruct.", "FEM-Design", "ModellingTools")
        {
