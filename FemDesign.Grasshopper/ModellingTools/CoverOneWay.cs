...
{
    public class CoverOneWay : FEM_Design_API_Component
    {
        public CoverOneWay() : base("Cover.OneWay", "OneWay", "Create a one way cover.", CategoryName.Name(), SubCategoryName.Cat3())
        {
