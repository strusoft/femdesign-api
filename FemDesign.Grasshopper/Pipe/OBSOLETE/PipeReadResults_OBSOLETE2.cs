...
{
    public class PipeReadResults_OBSOLETE2 : GH_AsyncComponent
    {
        public PipeReadResults_OBSOLETE2() : base("FEM-Design.GetResults", "GetResults", "Read Results from a model. .csv list files are saved in the same work directory as StruxmlPath.\nDO NOT USE THE COMPONENT IF YOU WANT TO PERFORM ITERATIVE ANALYSIS (i.e. Galapos)", CategoryName.Name(), SubCategoryName.Cat8())
        {
            BaseWorker = new ApplicationReadResultWorker_OBSOLETE2(this);
        }
    ...
    public class ApplicationReadResultWorker_OBSOLETE2 : WorkerInstance
    {
        /* INPUT/OUTPUT */
        ...
        public ApplicationReadResultWorker_OBSOLETE2(GH_Component component) : base(component) { }
        ...
        public override WorkerInstance Duplicate() => new ApplicationReadResultWorker_OBSOLETE2(Parent);
