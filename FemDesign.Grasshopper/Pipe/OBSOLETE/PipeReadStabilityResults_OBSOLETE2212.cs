...
{
    public class PipeStabilityResults_OBSOLETE2212 : GH_AsyncComponent
    {
        public PipeStabilityResults_OBSOLETE2212() : base("FEM-Design.GetStabilityResults", "StabilityResults", "Read the stability results from a model. .csv list files are saved in the same work directory as StruxmlPath.\nDO NOT USE THE COMPONENT IF YOU WANT TO PERFORM ITERATIVE ANALYSIS (i.e. Galapos)", CategoryName.Name(), SubCategoryName.Cat8())
        {
            BaseWorker = new ApplicationReadStabilityResultWorker_OBSOLETE2212(this);
        }
    ...
    public class ApplicationReadStabilityResultWorker_OBSOLETE2212 : WorkerInstance
    {
        ...
        public ApplicationReadStabilityResultWorker_OBSOLETE2212(GH_Component component) : base(component) { }
        ...
        public override WorkerInstance Duplicate() => new ApplicationReadStabilityResultWorker_OBSOLETE2212(Parent);
