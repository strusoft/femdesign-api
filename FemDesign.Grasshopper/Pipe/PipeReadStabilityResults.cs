...
//        public List<dynamic> _getNodalBuckling(Type resultType, List<string> loadCombinations = null, List<int?> shapeIds = null, Results.UnitResults units = null, Options options = null)
//        {
...
namespace FemDesign.Grasshopper
{
    ...
    public class ApplicationReadStabilityResultWorker : WorkerInstance
    {
        ...
        private DataTree<Results.IResult> _results = new DataTree<Results.IResult>();
        private DataTree<double> _critParam = new DataTree<double>();
        private bool _runNode = true;
        private bool _success = false;
