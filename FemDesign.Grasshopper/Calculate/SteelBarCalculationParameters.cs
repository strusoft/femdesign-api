...
namespace FemDesign.Grasshopper
{
    public class SteelCalculationParameters : SubComponent
    {
        ...
        public override void registerEvaluationUnits(EvaluationUnitManager mngr)
        {
            ...
            evaluationUnit.RegisterInputParam(new Param_Boolean(), "PlasticCalculation", "PlasticCalculation", "", GH_ParamAccess.item, new GH_Boolean(false));
            evaluationUnit.Inputs[evaluationUnit.Inputs.Count - 1].Parameter.Optional = true;


            evaluationUnit.RegisterInputParam(new Param_Boolean(), "Equation6.41", "Equation6.41", "", GH_ParamAccess.item, new GH_Boolean(false));
            evaluationUnit.Inputs[evaluationUnit.Inputs.Count - 1].Parameter.Optional = true;


            evaluationUnit.RegisterInputParam(new Param_Boolean(), "Class4", "Class4", "", GH_ParamAccess.item, new GH_Boolean(false));
            evaluationUnit.Inputs[evaluationUnit.Inputs.Count - 1].Parameter.Optional = true;


            evaluationUnit.RegisterInputParam(new Param_Boolean(), "Ignore", "Ignore", "", GH_ParamAccess.item, new GH_Boolean(false));
            evaluationUnit.Inputs[evaluationUnit.Inputs.Count - 1].Parameter.Optional = true;


            evaluationUnit.RegisterInputParam(new Param_Number(), "Convergence", "Convergence", "", GH_ParamAccess.item, new GH_Number(1.00));
            evaluationUnit.Inputs[evaluationUnit.Inputs.Count - 1].Parameter.Optional = true;


            evaluationUnit.RegisterInputParam(new Param_Integer(), "Iteration", "Iteration", "", GH_ParamAccess.item, new GH_Integer(50));
            evaluationUnit.Inputs[evaluationUnit.Inputs.Count - 1].Parameter.Optional = true;
        ...
        public override void SolveInstance(IGH_DataAccess DA, out string msg, out GH_RuntimeMessageLevel level)
        {
            ...
            DA.GetData(2, ref plasticCalculation);

            bool equation641 = false;
            DA.GetData(3, ref equation641);

            bool class4 = false;
            DA.GetData(4, ref class4);

            bool ignore = false;
            DA.GetData(5, ref ignore);

            double convergence = 1.00;
            DA.GetData(6, ref convergence);
            ...
            DA.GetData(11, ref en1993_1_1_6_3_2_2);
