...
namespace FemDesign.Grasshopper
{
    public class CalculationParametersDesignDefine : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.GetData(4, ref applychanges); //uncomment the line when we get response from the developer.


            FemDesign.Calculate.Design _obj = new FemDesign.Calculate.Design(_mode, autoDesign, check, isLoadCombination, applychanges);
