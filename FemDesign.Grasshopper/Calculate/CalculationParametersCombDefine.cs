...
namespace FemDesign.Grasshopper
{
    ...
    {
        public CalculationParametersCombDefine(): base("Comb.Define", "Define", "Define calculation parameters for the Load combinations calculation type. To setup which analysis types to consider for a specific load combination - use LoadCombination.SetupCalculation", CategoryName.Name(), SubCategoryName.CatCalculate())
        {
