...
namespace FemDesign.Grasshopper
{
    ...
    public class ModelRunAnalysisOBSOLETE: GH_Component
    {
        ...
        public ModelRunAnalysisOBSOLETE(): base("Application.RunAnalysis", "RunAnalysis", "Run analysis of model. .csv list files and .docx documentation files are saved in the same work directory as StruxmlPath.", CategoryName.Name(), SubCategoryName.CatCalculate())
        {
