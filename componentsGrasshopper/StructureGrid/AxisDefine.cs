...
namespace FemDesign.GH
{
    public class AxisDefine: GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            FemDesign.Geometry.FdPoint3d p0 = Geometry.FdPoint3d.FromRhino(line.PointAtStart);
            FemDesign.Geometry.FdPoint3d p1 = Geometry.FdPoint3d.FromRhino(line.PointAtEnd);
