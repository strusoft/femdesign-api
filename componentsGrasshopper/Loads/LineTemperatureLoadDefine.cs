...
namespace FemDesign.GH
{
    ...
    {
        public LineTemperatureLoadDefine(): base("LineTemperatureLoad.Define", "Define", "Define a surface temperature load", "FemDesign", "Loads")
        {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // convert geometry
            Geometry.Edge edge = Geometry.Edge.FromRhinoLineOrArc1(crv);
            Geometry.FdVector3d v = Geometry.FdVector3d.FromRhino(dir);
