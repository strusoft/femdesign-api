...
namespace FemDesign.GH
{
    public class PanelContinuousAnalyticalModelDeconstruct: GH_Component
    {
       ...
       protected override void SolveInstance(IGH_DataAccess DA)
       {
            ...
            DA.SetData(1, obj.InternalPanels.IntPanels[0].Region.ToDynamoSurface());
            DA.SetData(2, obj.Material);
            DA.SetData(3, obj.Section);
            DA.SetData(4, obj.InternalPanels.IntPanels[0].Region.ToDynamoCurves());
            DA.SetData(5, obj.InternalPanels.IntPanels[0].Region.GetEdgeConnections());
            DA.SetData(6, obj.LocalX);
            DA.SetData(7, obj.LocalY);
